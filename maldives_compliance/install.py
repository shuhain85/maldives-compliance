...
from maldives_compliance.audit_trail.setup import setup_fixtures as setup_audit_trail
from maldives_compliance.gst_india.constants import BUG_REPORT_URL
from maldives_compliance.gst_india.setup import after_install as setup_gst
from maldives_compliance.gst_india.setup import (
    create_education_custom_fields,
    create_hrms_custom_fields,
)
from maldives_compliance.income_tax_india.setup import after_install as setup_income_tax
...
def run_post_install_patches():
    ...
    try:
        for patch in POST_INSTALL_PATCHES:
            frappe.get_attr(f"maldives_compliance.patches.post_install.{patch}.execute")()
