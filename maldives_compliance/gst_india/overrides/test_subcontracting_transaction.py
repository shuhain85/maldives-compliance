...
from maldives_compliance.gst_india.utils.tests import create_transaction
...
class TestSubcontractingTransaction(FrappeTestCase):
    ...
    def test_validation_for_doc_references(self):
        from maldives_compliance.gst_india.overrides.subcontracting_transaction import (
