...
from maldives_compliance.gst_india.utils import get_place_of_supply_options
    ...
    "Subcontracting Order": [
        {
            ...
            "insert_after": "total",
            "hide_border": 1,
            "depends_on": "eval: doc.purchase_order && maldives_compliance.is_e_waybill_applicable_for_subcontracting(doc)",
        },
    ],
    "Subcontracting Receipt": [
        {
            ...
            "insert_after": "total",
            "hide_border": 1,
            "depends_on": "eval: maldives_compliance.is_e_waybill_applicable_for_subcontracting(doc)",
        },
        {
