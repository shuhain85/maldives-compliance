...
from maldives_compliance.gst_india.utils.gstr_1 import GSTR1_SubCategory
...
def get_json(filters, report_name, data):
    from maldives_compliance.gst_india.report.gstr_1.gstr_1 import get_company_gstin_number
