{% include "maldives_compliance/gst_india/client_scripts/party.js" %}
...
frappe.ui.form.on(DOCTYPE, {
    ...
    setup(frm) {
        ...
        frm.set_query("print_label", "bank_details_for_printing", (_, cdt, cdn) => {
            return  {
                query: "maldives_compliance.gst_india.overrides.company.get_default_print_options",
                params : {for_bank : 1}
            }
        });
    ...
    make_default_tax_template: function (frm) {
        ...
        frappe.call({
            method: "maldives_compliance.gst_india.overrides.company.make_default_tax_templates",
