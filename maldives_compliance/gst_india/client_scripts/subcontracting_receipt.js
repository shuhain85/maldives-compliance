...
frappe.ui.form.on(DOCTYPE, {
    setup(frm) {
        ...
        frm.set_query("link_name", "doc_references", function (doc, cdt, cdn) {
            ...
            if (row.link_doctype == "Stock Entry")
                return {
                    query: "maldives_compliance.gst_india.overrides.subcontracting_transaction.get_stock_entry_references",
                    filters: {
                        ...filters,
                ...
                return {
                    query: "maldives_compliance.gst_india.overrides.subcontracting_transaction.get_subcontracting_receipt_references",
                    filters: {
                        ...filters,
    ...
    onload(frm) {
        frm.taxes_controller = new maldives_compliance.taxes_controller(frm, {
    ...
    fetch_original_doc_ref(frm) {
        ...
        frappe.call({
            method: "maldives_compliance.gst_india.overrides.subcontracting_transaction.get_relevant_references",
            args: {
                filters: {
...
frappe.ui.form.on(
    ...
    maldives_compliance.taxes_controller_events
);
