...
from maldives_compliance.gst_india.utils.gstin_info import get_and_update_filing_preference
from maldives_compliance.gst_india.utils.gstr_1 import (
...
from maldives_compliance.gst_india.utils.gstr_1 import GSTR1_DataField as df
from maldives_compliance.gst_india.utils.gstr_1 import (
    GSTR1_SubCategory,
)
from maldives_compliance.gst_india.utils.gstr_1.gstr_1_download import (
    download_gstr1_json_data,
)
from maldives_compliance.gst_india.utils.gstr_1.gstr_1_json_map import (
    GSTR1BooksData,
...
class GenerateGSTR1(SummarizeGSTR1, ReconcileGSTR1, AggregateInvoices):
    ...
    def get_books_gstr1_data(self, filters, aggregate=False):
        from maldives_compliance.gst_india.doctype.gstr_1_beta.gstr_1_beta import (
