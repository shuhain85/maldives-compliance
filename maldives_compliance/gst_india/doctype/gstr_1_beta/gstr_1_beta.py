...
from maldives_compliance.gst_india.utils.gstin_info import get_gstr_1_return_status
...
def perform_gstr1_action(action, month_or_quarter, year, company_gstin, **kwargs):
    ...
    if action == "upload_gstr1":
        from maldives_compliance.gst_india.doctype.gstr_1_beta.gstr_1_export import (
            get_gstr_1_json,
        )
