...
const DOC_PATH =
    "maldives_compliance.gst_india.doctype.gst_invoice_management_system.gst_invoice_management_system";
...
async function set_period_options(frm) {
    ...
    const { message: period_options } = await frappe.call({
        method: "maldives_compliance.gst_india.doctype.gst_invoice_management_system.gst_invoice_management_system.get_period_options",
