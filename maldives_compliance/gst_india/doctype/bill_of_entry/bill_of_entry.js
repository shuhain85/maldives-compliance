...
frappe.ui.form.on("Bill of Entry", {
    ...
    refresh(frm) {
        maldives_compliance.set_reconciliation_status(frm, "bill_of_entry_no");
            ...
            frm.add_custom_button(
                ...
                () => {
                    frappe.model.open_mapped_doc({
                        method: "maldives_compliance.gst_india.doctype.bill_of_entry.bill_of_entry.make_journal_entry_for_payment",
                        frm: frm,
                    });
                },
                __("Create")
        ...
        if (
            ...
            frm.add_custom_button(
                ...
                () => {
                    frappe.model.open_mapped_doc({
                        method: "maldives_compliance.gst_india.doctype.bill_of_entry.bill_of_entry.make_landed_cost_voucher",
                        frm: frm,
                    });
                },
                __("Create")
    ...
    get_items_from_purchase_invoice(frm) {
        ...
        const d = new frappe.ui.form.MultiSelectDialog({
            ...
            get_query() {
                return {
                    query: "maldives_compliance.gst_india.doctype.bill_of_entry.bill_of_entry.fetch_pending_boe_invoices",
                };
            },
            add_filters_group: 1,
...
class BillOfEntryController {
    constructor(frm) {
        this.frm = frm;
        this.frm.taxes_controller = new maldives_compliance.taxes_controller(frm);
        this.setup();
    }
