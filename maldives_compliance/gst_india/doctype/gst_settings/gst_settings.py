...
from maldives_compliance.gst_india.constants.custom_fields import (
    E_INVOICE_FIELDS,
    E_WAYBILL_FIELDS,
...
from maldives_compliance.gst_india.doctype.gstin.gstin import get_gstr_1_filed_upto
from maldives_compliance.gst_india.page.maldives_compliance_account import (
    _disable_api_promo,
    post_login,
)
...
from maldives_compliance.gst_india.utils.gstin_info import get_gstin_info
from maldives_compliance.utils.custom_fields import toggle_custom_fields
...
class GSTSettings(Document):
    ...
    def update_retry_e_invoice_e_waybill_scheduled_job(self):
        ...
        frappe.db.set_value(
            "Scheduled Job Type",
            {
                "method": "maldives_compliance.gst_india.utils.e_invoice.retry_e_invoice_e_waybill_generation"
            },
            "stopped",
    ...
    def update_auto_refresh_authtoken_scheduled_job(self):
        ...
        frappe.db.set_value(
            "Scheduled Job Type",
            {
                "method": "maldives_compliance.gst_india.doctype.purchase_reconciliation_tool.purchase_reconciliation_tool.auto_refresh_authtoken"
            },
            "stopped",
