...
from maldives_compliance.gst_india.constants.e_waybill import (
    ADDRESS_FIELDS,
    CANCEL_REASON_CODES,
    CONSIGNMENT_STATUS,
...
def enqueue_bulk_e_waybill_generation(doctype, docnames):
    ...
    from maldives_compliance.gst_india.utils import is_api_enabled
    ...
    rq_job = frappe.enqueue(
        "maldives_compliance.gst_india.utils.e_waybill.generate_e_waybills",
        queue="long",
