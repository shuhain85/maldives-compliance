...
from maldives_compliance.gst_india.overrides.test_transaction import (
    create_refund_transaction,
)
from maldives_compliance.gst_india.utils import load_doc
...
from maldives_compliance.gst_india.utils.e_waybill import EWaybillData
from maldives_compliance.gst_india.utils.tests import append_item, create_sales_invoice
    ...
    def setUpClass(cls):
        ...
        cls.e_invoice_test_data = frappe._dict(
            frappe.get_file_json(
                frappe.get_app_path(
                    "maldives_compliance", "gst_india", "data", "test_e_invoice.json"
                )
            )
        )
