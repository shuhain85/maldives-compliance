...
from maldives_compliance.gst_india.api_classes.taxpayer_base import otp_handler
from maldives_compliance.gst_india.api_classes.taxpayer_e_invoice import (
    EInvoiceAPI as TaxpayerEInvoiceAPI,
)
from maldives_compliance.gst_india.constants import (
    CURRENCY_CODES,
    EXPORT_TYPES,
    GST_CATEGORIES,
    PORT_CODES,
...
from maldives_compliance.gst_india.constants.e_invoice import (
    CANCEL_REASON_CODES,
    ITEM_LIMIT,
)
from maldives_compliance.gst_india.doctype.gst_settings.gst_settings import (
    get_e_invoice_applicability_date,
)
from maldives_compliance.gst_india.overrides.transaction import validate_mandatory_fields
from maldives_compliance.gst_india.utils import (
    are_goods_supplied,
...
from maldives_compliance.gst_india.utils.e_waybill import (
    _cancel_e_waybill,
    generate_pending_e_waybills,
    log_and_process_e_waybill_generation,
)
from maldives_compliance.gst_india.utils.transaction_data import GSTTransactionData
...
def enqueue_bulk_e_invoice_generation(docnames):
    ...
    rq_job = frappe.enqueue(
        "maldives_compliance.gst_india.utils.e_invoice.generate_e_invoices",
