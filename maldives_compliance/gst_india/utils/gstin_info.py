...
from maldives_compliance.exceptions import GSPServerError
from maldives_compliance.gst_india.api_classes.base import BASE_URL
from maldives_compliance.gst_india.api_classes.e_invoice import EInvoiceAPI
from maldives_compliance.gst_india.api_classes.e_waybill import EWaybillAPI
from maldives_compliance.gst_india.api_classes.public import PublicAPI
from maldives_compliance.gst_india.api_classes.taxpayer_base import (
    otp_handler,
)
from maldives_compliance.gst_india.api_classes.taxpayer_returns import GSTR1API
from maldives_compliance.gst_india.utils import parse_datetime, titlecase, validate_gstin
...
def _get_gstin_info(gstin, *, doc=None, throw_error=True):
    ...
    if not response:
        try:
            ...
            frappe.enqueue(
                "maldives_compliance.gst_india.doctype.gstin.gstin.create_or_update_gstin_status",
                queue="long",
...
def update_gstr_returns_info(company, gstin, fy=None):
    ...
    from maldives_compliance.gst_india.doctype.gst_return_log.gst_return_log import (
...
def create_or_update_logs_for_year(gstin, period, response):
    ...
    # patch
    from maldives_compliance.patches.v15.update_return_logs_with_filing_preference import (
