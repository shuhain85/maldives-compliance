...
from maldives_compliance.gst_india.constants import GST_TAX_TYPES, SALES_DOCTYPES
...
from maldives_compliance.patches.post_install.update_e_invoice_fields_and_logs import (
