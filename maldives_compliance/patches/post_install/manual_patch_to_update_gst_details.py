...
from maldives_compliance.patches.post_install.set_gst_tax_type import (
    execute as set_gst_tax_type,
)
from maldives_compliance.patches.post_install.set_gst_tax_type_in_journal_entry import (
