...
frappe.provide("maldives_compliance.taxes_controller_events");

maldives_compliance.taxes_controller = class TaxesController {
    ...
    async set_item_wise_tax_rates(item_name, tax_name) {
        ...
        await frappe.call({
            method: "maldives_compliance.gst_india.utils.taxes_controller.set_item_wise_tax_rates",
            args: {
                doc: this.frm.doc,
                item_name: item_name,
                tax_name: tax_name,
...
Object.assign(maldives_compliance.taxes_controller_events, {
