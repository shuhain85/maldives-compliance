frappe.require("assets/maldives_compliance/js/quick_entry.js");
...
async function autofill_company_info(slide) {
    ...
    if (!maldives_compliance.validate_gstin(gstin)) {
...
function can_fetch_gstin_info() {
    return maldives_compliance.is_api_enabled() && !frappe.boot.gst_settings.sandbox_mode;
}
