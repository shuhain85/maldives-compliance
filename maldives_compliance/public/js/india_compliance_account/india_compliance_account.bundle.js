...
frappe.provide("maldives_compliance.pages");
maldives_compliance.pages.IndiaComplianceAccountPage = IndiaComplianceAccountPage;

frappe.provide("maldives_compliance.gst_api");
maldives_compliance.gst_api.call = async function (endpoint, options) {
    try {
